...
<div class="card border-primary mx-md-5 my-5 overflow-hidden">
    <div class="container-fluid">
        <div id="books_new" class="row g-3">
            <div class="card-title col-md-12 text-center my-3">
                <h4><i class="fa-solid fa-bullhorn"></i>新品上市</h4>
            </div>
            <?php while ($datanew = $new->fetch()) {  ?>
                <div class="card col-md-4 col-6 overflow-hidden card-index" title="<?php echo $datanew['p_name']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly">
                            <a href="./page_goods_book.php?p_id=<?php echo $datanew['p_id']; ?>" class="btn btn-primary" title="更多資訊"><span class="textinbtn">更多資訊</span><i class="fas fa-info-circle d-none"></i></a>
                            <!-- <a href="#" class="btn btn-success"><span class="textinbtn">放購物車</span><i class="fas fa-cart-shopping d-none"></i></a> -->
                            <button type="button" id="button01[]" name="button01[]" class="btn btn-success" title="放購物車" onclick="addcart(<?php echo $datanew['p_id']; ?>)"><span class="textinbtn">放購物車</span></span><i class="fas fa-cart-shopping d-none"></i></button>
                        </div>
                    </div>
                </div>
            <?php  } ?>
