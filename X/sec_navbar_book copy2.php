...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid row align-items-center justify-content-between">
        <!-- LOGO -->
        <div class="col-3" style="background-color: red;padding: 0;"><a class="navbar-brand" href="./index.php"><img src="./pro_book_images/bw_logo.svg" class="img_cos-contain" alt="bookwalker"></a></div>
        ...
        <div class="col-8 col-lg-4" style="background-color: yellow;padding: 0;">
        ...
        <!-- 摺疊按鈕，order:5 -->
        <div class="col-1" style="background-color: green;padding: 0;">
